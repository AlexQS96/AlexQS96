  ...
  return (
    <>
      ...
      <div className="contact">
        ...
        <RevealWrapper id='formContact' origin='left' delay={200} duration={1000} distance='500px' easing="cubic-bezier(.57,.21,.69,1.25)" >
        ...
        <RevealWrapper id='formImage' origin='right' delay={200} duration={1000} distance='500px' easing="cubic-bezier(.57,.21,.69,1.25)" >
